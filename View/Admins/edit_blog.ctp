    ...
    <div class="row" style="padding-top:20px">
      <div style="padding-right:0" class="col-md-12">
        <ol class="breadcrumb">
          ...
          <li><?php echo  $this->Html->link('Blog', array('controller'=>'Admins', 'action'=>'BlogList'))?></li>
    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-primary">
          <div class="panel-heading profileedit"><i class="fa fa-edit"></i>&nbsp; Edit Blog</div>
          <div class="panel-body ">
            <div class="col-md-12">
              ...
              <div class="login-wrap" style="padding:0;margin:0px auto;">
                ...
                <div class="col-md-9">
                  <?php echo $this->Form->input('title', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Blog Title','value'=>$edit_blog['Blog']['title']));?>
                </div>

                <div class="col-md-3 boxesstyle">Content</div>
                <div class="col-md-9">
                  <?php echo $this->Form->input('content' , array('type'=>'textarea','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','rows'=>20,'placeholder'=>'Description','value'=>$edit_blog['Blog']['content']));?>
                </div>
                ...
                <div class="col-md-6" style="padding-top:20px">
                  <input type="submit" class="btn btn-default savebtn" value="Update Blog">
