    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-primary">
          <div class="panel-heading profileedit"><i class="fa fa-edit"></i>&nbsp; Edit FAQ</div>
          <div class="panel-body ">
            <div class="col-md-12">
              ...
              <div class="login-wrap" style="padding:0;margin:0px auto;">
                ...
                <div class="col-md-9">
                  <?php echo $this->Form->input('question', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'Blog Title','value'=>$edit_faq['question']));?>
                </div>

                <div class="col-md-3 boxesstyle">FAQ Answer</div>
                <div class="col-md-9">
                  <?php echo $this->Form->input('answer' , array('type'=>'textarea','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','rows'=>10,'placeholder'=>'FAQ Answer','value'=>$edit_faq['answer']));?>
                </div>
				 
                
                <div class="col-md-6" style="padding-top:20px">
                  <input type="submit" class="btn btn-default savebtn" value="Update FAQ">
