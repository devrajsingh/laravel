    ...
    <div class="row">
      <div class="col-md-12">
        <div class="panel panel-default panel-primary">
          <div class="panel-heading profileedit"><i class="fa fa-user"></i>&nbsp; Add News</div>
          <div class="panel-body ">
            <div class="col-md-12">
              ...
              <div class="login-wrap" style="padding:0;margin:0px auto;">
                ...
                <div class="col-md-9">
                  <?php echo $this->Form->input('title', array('type'=>'text','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','placeholder'=>'News Title'));?>
                </div>

                <div class="col-md-3 boxesstyle">Content</div>
                <div class="col-md-9">
                  <?php echo $this->Form->input('content' , array('type'=>'textarea','label' => false,'div'=>false, 'class' => 'form-control boxesstyle','rows'=>20,'placeholder'=>'Description'));?>
                </div>
                ...
                <div class="col-md-6" style="padding-top:20px">
                  <input type="submit" class="btn btn-default savebtn" value="Add News">
